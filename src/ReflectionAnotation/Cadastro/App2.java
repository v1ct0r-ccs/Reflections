...
import ReflectionAnotation.Cadastro.Fabrica.IFabricaPersistente;
import ReflectionAnotation.Cadastro.Fabrica.Factory;
import ReflectionAnotation.Cadastro.Fabrica.IFactory;
...
public class App2 {
    ...
    private static void executarOpcaoExcluir(String opcaoMenuGeral) {
        ...
        getDAO(opcaoMenuGeral).excluir(String.valueOf(Long.parseLong(dados)));
    ...
    private static void executarOpcaoConsultar(String opcaoMenuGeral) {
        ...
        IPersistente persistente = consultar(dados, opcaoMenuGeral);
        if (persistente != null) {
     ...
     */
    private static IPersistente consultar(String dados, String opcaoMenuGeral) {
    ...
    private static void cadastrar(String dados, String opcaoMenuGeral) throws DadosInvalidosException {
        String[] dadosSeparados = dados.split(",");
        IPersistente persistente = criarObjetoConcreto(dadosSeparados, opcaoMenuGeral);
     ...
     * @return
     */
    private static Boolean cadastrarObjeto(String opcaoMenuGeral, IPersistente persistente) throws TipoChaveNaoEncontradaException {
     ...
     * @throws DadosInvalidosException quando os dados estão inválidos
     */
    private static IPersistente criarObjetoConcreto(String[] dadosSeparados, String opcaoMenuGeral) throws DadosInvalidosException {
